      ...
      <section className="bg-gradient-to-r from-gray-50 to-gray-400 py-3 md:py-6">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-bold leading-tight text-gray-800 sm:text-xl lg:text-4xl">
              Contact us
            </h2>
            <p className="max-w-xl mx-auto mt-2 text-base leading-relaxed text-slate-600">
            ...
            <div className="grid items-stretch grid-cols-1 lg:grid-cols-5">
              <div className="lg:col-span-3">
                <div className="p-3 sm:p-8">
                  <h3 className="text-md lg:text-2xl font-semibold text-black">
                    Send us a message
                  </h3>
